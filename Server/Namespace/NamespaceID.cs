 ...
 *     Namespace: [a-z0-9.-_]
    Value: [a-z0-9.-_/]
 */
public partial class NamespaceId
{
    
    private static readonly Regex NamespaceRegex = MyRegex();
    private static readonly Regex DomainRegex = MyRegex1();
    ...
    [GeneratedRegex(@"^([a-z0-9.-_]+)([a-z0-9.-_/]+)$", RegexOptions.Compiled)]
