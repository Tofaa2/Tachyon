...
import net.tachyon.command.arguments.minecraft.*;
import net.tachyon.command.arguments.minecraft.registry.*;
import net.tachyon.command.arguments.number.ArgumentDouble;
import net.tachyon.command.arguments.number.ArgumentFloat;
import net.tachyon.command.arguments.number.ArgumentInteger;
import net.tachyon.command.arguments.number.ArgumentLong;
import net.tachyon.command.arguments.relative.ArgumentRelativeBlockPosition;
import net.tachyon.command.arguments.relative.ArgumentRelativeVec2;
import net.tachyon.command.arguments.relative.ArgumentRelativeVec3;
