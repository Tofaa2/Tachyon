...
import net.tachyon.network.packet.server.play.OpenWindowPacket;
...
import net.tachyon.network.packet.server.play.WindowPropertyPacket;
...
public class Inventory implements InventoryModifier, InventoryClickHandler, Viewable, DataContainer {
    ...
    public Inventory(@NotNull InventoryType inventoryType, @NotNull Component title) {
        ...
        ArrayUtils.fill(itemStacks, () -> ItemStack.AIR);
    }
    ...
    public void setTitle(@NotNull Component title) {
        ...
        OpenWindowPacket packet = new OpenWindowPacket(getWindowId(), getInventoryType().getWindowType(), title, (byte) getSize(), 0);
