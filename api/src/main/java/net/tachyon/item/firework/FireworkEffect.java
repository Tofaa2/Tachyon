package net.tachyon.item.firework;

import net.tachyon.utils.Color;
...
public class FireworkEffect {
    ...
    public static FireworkEffect fromCompound(@NotNull NBTCompound compound) {
        ...
        if (compound.containsKey("Colors")) {
            ...
            primaryColor = Color.fromRGB((byte) color[0], (byte) color[1], (byte) color[2]);
        }

        if (compound.containsKey("FadeColors")) {
            int[] fadeColor = compound.getIntArray("FadeColors");
            secondaryColor = Color.fromRGB((byte) fadeColor[0], (byte) fadeColor[1], (byte) fadeColor[2]);
