...
public class CollisionUtils {
     ...
     */
    private static boolean stepAxis(World instance, Vec startPosition, Vec axis, double stepAmount, Vec positionOut, Vec[] corners) {
     ...
     */
    private static StepOnceData stepOnce(World instance, Vec axis, double amount, Vec[] cornersCopy, Point[] cornerPositions) {
    ...
    private static class StepOnceData {
        ...
        public StepOnceData(World instance, Vec axis, double amount, Vec[] cornersCopy, Point[] cornerPositions) {
     ...
     */
    @NotNull
    public static Position applyWorldBorder(@NotNull World instance,
