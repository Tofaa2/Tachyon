...
public final class UpdateManager {
     ...
     */
    UpdateManager(@NotNull Server server, @NotNull ConnectionManager connectionManager) {
    ...
    void start() {
        updateExecutionService.scheduleAtFixedRate(() -> {
            try {
                ...
                server.getSchedulerManager().processTick();
        ...
        }, 0, Tachyon.getServer().getTickMs(), TimeUnit.MILLISECONDS);
    }
