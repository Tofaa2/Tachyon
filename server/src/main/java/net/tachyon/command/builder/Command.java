...
import net.tachyon.command.builder.arguments.minecraft.SuggestionType;
import net.tachyon.command.CommandSender;
import net.tachyon.command.builder.arguments.Argument;
import net.tachyon.command.builder.arguments.ArgumentDynamicStringArray;
import net.tachyon.command.builder.arguments.ArgumentDynamicWord;
import net.tachyon.command.builder.arguments.ArgumentType;
import net.tachyon.command.builder.condition.CommandCondition;
