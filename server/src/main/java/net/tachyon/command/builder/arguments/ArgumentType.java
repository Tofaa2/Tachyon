...
import net.tachyon.command.builder.arguments.minecraft.*;
import net.tachyon.command.builder.arguments.minecraft.registry.*;
import net.tachyon.command.builder.arguments.number.ArgumentDouble;
import net.tachyon.command.builder.arguments.number.ArgumentFloat;
import net.tachyon.command.builder.arguments.number.ArgumentInteger;
import net.tachyon.command.builder.arguments.number.ArgumentLong;
import net.tachyon.command.builder.arguments.relative.ArgumentRelativeBlockPosition;
import net.tachyon.command.builder.arguments.relative.ArgumentRelativeVec2;
import net.tachyon.command.builder.arguments.relative.ArgumentRelativeVec3;
