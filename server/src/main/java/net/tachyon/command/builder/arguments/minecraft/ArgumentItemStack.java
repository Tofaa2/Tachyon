...
/**
 * Argument which can be used to retrieve an {@link TachyonItemStack} from its material and with NBT data.
 * <p>
...
public class ArgumentItemStack extends Argument<ItemStack> {
    ...
    public ItemStack parse(@NotNull String input) throws ArgumentSyntaxException {
        ...
        if (nbtIndex == -1) {
            ...
            ItemStack itemStack = ItemStack.of(material, (byte) 1);
            ...
            return NBTUtils.loadDataIntoItem(itemStack, compound);
        }
    }
