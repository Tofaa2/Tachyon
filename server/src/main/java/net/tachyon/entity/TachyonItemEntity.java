 ...
 */
public class TachyonItemEntity extends ObjectEntity implements ItemEntity {
    ...
    public TachyonItemEntity(@NotNull ItemStack itemStack, @NotNull Position spawnPosition) {
        super(EntityType.ITEM, spawnPosition);
        setItemStack(itemStack);
        setBoundingBox(0.25f, 0.25f, 0.25f);
    }

    public TachyonItemEntity(@NotNull ItemStack itemStack, @NotNull Position spawnPosition, @Nullable Instance instance) {
    ...
    public static void setMergeUpdateOption(@Nullable UpdateOption mergeUpdateOption) {
        TachyonItemEntity.mergeUpdateOption = mergeUpdateOption;
    }
    ...
    /**
     * When set to true, close {@link TachyonItemEntity} will try to merge together as a single entity
     * when their {@link #getItemStack()} is similar and allowed to stack together.
     *
     * @param mergeable should the entity merge with other {@link TachyonItemEntity}
     */
