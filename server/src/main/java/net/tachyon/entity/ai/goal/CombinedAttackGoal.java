...
public class CombinedAttackGoal extends GoalSelector {
    ...
    private Function<TachyonEntity, EntityProjectile> projectileGenerator;

    private long lastAttack;
    private boolean stop;
    private TachyonEntity cachedTarget;
    ...
    public void setProjectileGenerator(Function<TachyonEntity, EntityProjectile> projectileGenerator) {
        ...
        if (distanceSquared <= this.meleeRangeSquared) {
            ...
            if (!CooldownUtils.hasCooldown(time, this.lastAttack, this.rangedTimeUnit, this.rangedDelay)) {
                if (this.entityCreature.hasLineOfSight(target)) {
                    ...
                    Position to = target.getPosition().add(0D, target.getEyeHeight(), 0D);

                    Function<TachyonEntity, EntityProjectile> projectileGenerator = this.projectileGenerator;
