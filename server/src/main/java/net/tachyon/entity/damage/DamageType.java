...
/**
 * Represents a type of damage, required when calling {@link TachyonLivingEntity#damage(DamageType, float)}
...
public class DamageType implements DataContainer {
    ...
    protected SoundEvent getGenericSound(@NotNull LivingEntity entity) {
        return switch (((TachyonLivingEntity) entity).getEntityType()) {
