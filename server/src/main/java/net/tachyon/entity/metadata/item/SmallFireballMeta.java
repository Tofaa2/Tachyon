...
public class SmallFireballMeta extends TachyonEntityMeta implements ObjectDataProvider, ProjectileMeta {

    private Entity shooter;

    public SmallFireballMeta(@NotNull TachyonEntity entity, @NotNull Metadata metadata) {
