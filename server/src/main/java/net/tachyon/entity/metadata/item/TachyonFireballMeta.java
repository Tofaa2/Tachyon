...
public class TachyonFireballMeta extends TachyonEntityMeta implements FireballMeta {

    private Entity shooter;

    public TachyonFireballMeta(@NotNull Entity entity, @NotNull Metadata metadata) {
