...
public class TachyonSmallFireballMeta extends TachyonEntityMeta implements SmallFireballMeta {

    private Entity shooter;

    public TachyonSmallFireballMeta(@NotNull Entity entity, @NotNull Metadata metadata) {
