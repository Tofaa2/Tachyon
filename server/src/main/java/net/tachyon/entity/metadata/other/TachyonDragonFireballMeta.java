...
public class TachyonDragonFireballMeta extends TachyonEntityMeta implements ObjectDataProvider, ProjectileMeta {

    private Entity shooter;

    public TachyonDragonFireballMeta(@NotNull TachyonEntity entity, @NotNull Metadata metadata) {
