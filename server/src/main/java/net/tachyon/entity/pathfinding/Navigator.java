...
public class Navigator {
    ...
    public Navigator(@NotNull TachyonEntity entity) {
        this.entity = entity;
    ...
    public void moveTowards(@NotNull Position direction, double speed) {
        ...
        entity.UNSAFE_modifyPosition(newPosition);
    }
    ...
    public synchronized boolean setPathTo(@Nullable Position position, boolean bestEffort) {
        ...
        final TachyonChunk chunk = instance.getChunkAt(position);
    ...
    public synchronized void tick(float speed) {
        ...
        if (entity instanceof TachyonLivingEntity && ((TachyonLivingEntity) entity).isDead())
            return;
