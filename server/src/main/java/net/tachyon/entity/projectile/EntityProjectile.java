 ...
 */
public class EntityProjectile extends TachyonEntity {

    private final TachyonEntity shooter;

    private boolean hasNoGravity = false;

    public EntityProjectile(@Nullable TachyonEntity shooter, @NotNull EntityType entityType) {
        super(entityType);
    ...
    @Deprecated
    public EntityProjectile(@Nullable TachyonEntity shooter, @NotNull EntityType entityType, @NotNull Position spawnPosition) {
    ...
    @Nullable
    public TachyonEntity getShooter() {
        return this.shooter;
    }
