...
import net.tachyon.network.packet.client.ClientPacket;
 ...
 * <p>
 * If you want to fill the packet from a buffer, consider using {@link ClientPacket#read(net.tachyon.binary.BinaryReader)} after getting the packet instance.
 */
