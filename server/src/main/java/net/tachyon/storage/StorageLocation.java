package net.tachyon.storage;

import net.tachyon.MinecraftServer;
import net.tachyon.Tachyon;
import net.tachyon.data.*;
...
public class StorageLocation {
    ...
    private static final DataManager DATA_MANAGER = Tachyon.getServer().getDataManager();
     ...
     * <p>
     * It does use registered {@link DataType} located on {@link TachyonDataManager}
    ...
    public <T> T get(@NotNull String key, @NotNull Class<T> type) {
        ...
        // Decode the data
        TachyonBinaryReader binaryReader = new TachyonBinaryReader(data);
